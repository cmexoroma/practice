...
public class StudentServiceTests
{
    ...
    public StudentServiceTests()
    {
        ...
        {
            new() { Name = "Иван", Faculty = "ФИТ", Grades = new List<int> { 5, 4, 5 } }, //avg = 4.66
            new() { Name = "Анна", Faculty = "ФИТ", Grades = new List<int> { 3, 4, 3 } }, //avg = 3.33
            new() { Name = "Петр", Faculty = "Экономика", Grades = new List<int> { 5, 5, 5 } } //avg = 5
        };
